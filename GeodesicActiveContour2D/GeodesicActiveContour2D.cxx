...
int DoIt( int argc, char * argv[], T )
{
    ...
    ImageType::Pointer imag_out = ImageType::New();
    segment seg;
    seg.Execute(first,last,sigma_min,sigma_max,propagation,curvature,advection,rms,iterations,alpha,beta,distance);
    seg.Execute2(first,last,sigma_min,sigma_max,propagation,curvature,advection,rms,iterations,alpha,beta,distance);
