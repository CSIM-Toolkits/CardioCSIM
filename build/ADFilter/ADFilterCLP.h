...
//  /home/gustavo/Slicer/Slicer/Slicer-SuperBuild-Debug/SlicerExecutionModel-build/GenerateCLP/bin/GenerateCLP --InputXML /home/gustavo/CardioCSIM/ADFilter/ADFilter.xml --OutputCxx /home/gustavo/CardioCSIM/build/ADFilter/ADFilterCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"  <title>ADFilter</title>\n"
"  <description><![CDATA[This is a CLI module that can be bundled in an extension]]></description>\n"
"  <version>0.0.1</version>\n"
"  <documentation-url>http://www.example.com/Slicer/Modules/ADFilter</documentation-url>\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << "A double value (in units of mm) passed to the algorithm (default: " << it << ")"; \
    TCLAP::ValueArg<int > itArg("y", "it", msg.str(), 0, it, "int", commandLine); \
 \
    msg.str("");msg << "A double value (in units of mm) passed to the algorithm (default: " << conductance << ")"; \
    TCLAP::ValueArg<double > conductanceArg("k", "conductance", msg.str(), 0, conductance, "double", commandLine); \
 \
