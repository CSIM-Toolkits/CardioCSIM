...
//  /home/gustavo/Slicer/Slicer/Slicer-SuperBuild-Debug/SlicerExecutionModel-build/GenerateCLP/bin/GenerateCLP --InputXML /home/gustavo/CardioCSIM/HoughTransform/HoughTransform.xml --OutputCxx /home/gustavo/CardioCSIM/build/HoughTransform/HoughTransformCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"  <title>HoughTransform</title>\n"
"  <description><![CDATA[This is a CLI module that can be bundled in an extension]]></description>\n"
"  <version>0.0.1</version>\n"
"  <documentation-url>http://www.example.com/Slicer/Modules/HoughTransform</documentation-url>\n"
...
"    </image>\n"
"    <integer>\n"
"      <name>sliceBegin</name>\n"
"      <longflag>slicebegin</longflag>\n"
"      <flag>s</flag>\n"
"      <label>Slice Begin</label>\n"
"      <description><![CDATA[A integer value (in units of mm) passed to the algorithm]]></description>\n"
"      <default>1</default>\n"
"    </integer>\n"
"    <integer>\n"
"      <name>sliceEnd</name>\n"
"      <longflag>sliceend</longflag>\n"
"      <flag>e</flag>\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << "A integer value (in units of mm) passed to the algorithm (default: " << sliceBegin << ")"; \
    TCLAP::ValueArg<int > sliceBeginArg("s", "slicebegin", msg.str(), 0, sliceBegin, "int", commandLine); \
 \
    msg.str("");msg << "A integer value (in units of mm) passed to the algorithm (default: " << sliceEnd << ")"; \
    TCLAP::ValueArg<int > sliceEndArg("e", "sliceend", msg.str(), 0, sliceEnd, "int", commandLine); \
 \
...
#define GENERATE_TCLAP_ASSIGNMENT \
      ...
      sliceBegin = sliceBeginArg.getValue(); \
      sliceEnd = sliceEndArg.getValue(); \
...
#define GENERATE_TCLAP_ASSIGNMENT_IFSET \
    ...
    if( sliceBeginArg.isSet() ) \
      { \
      sliceBegin = sliceBeginArg.getValue(); \
      } \
    if( sliceEndArg.isSet() ) \
      { \
      sliceEnd = sliceEndArg.getValue(); \
      } \
...
std::cout << "    sliceBegin: " << sliceBegin << std::endl; \
